...
class CategorizeNsave:
    ...
    def __init__(self, sample_name='Stream1'):
        ...
        if sample_name == 'Stream1':
            ...
            try:
                self.c.execute("CREATE TABLE IF NOT EXISTS twts_%s (twtid VARCHAR(18) PRIMARY KEY);"%self.sample_name)
                self.c.execute("CREATE TABLE IF NOT EXISTS users_%s (\
    ...
    def __defaultvars__(self):
        #saved so far...
        self.c.execute("SELECT * FROM twts_%s;"%self.sample_name)
    ...
    def master_user(self,
        ...
        self.c.execute("REPLACE INTO user_numbers (userid, numfriends, numfollowers) \
                       ...
                       (userid,
                        ...
                        numfollowers))
        self.conn.commit()
        self.c.execute("INSERT IGNORE INTO users_%s (userid) VALUES (%s);",
                       (self.sample_name,
                        userid))
        self.conn.commit()
        #------------------------------
    ...
    def write_sample_table(self, twtid):
        ...
        self.c.execute("INSERT INTO twts_%s (twtid) VALUES (%s)"%(self.sample_name,
                                                             twtid))
        self.conn.commit()
        #------------------------------ 
